...
export async function generateBusinessProcesses(input: {
  ...
  const system =
    "Είσαι ειδικός αναλυτής επιχειρησιακών διαδικασιών (Business Process Management). Σχεδιάζεις ΔΙΑΔΙΚΑΣΙΕΣ ΡΟΗΣ ΕΡΓΑΣΙΑΣ " +
    "(workflows), ΟΧΙ λίστες εργασιών (project tasks). Από την περιγραφή μιας ΕΠΙΧΕΙΡΗΣΗΣ και τους ΚΑΔ που περιγράφουν το " +
    "επαγγελματικό της αντικείμενο, προτείνεις ΠΕΡΙΠΟΥ 20 (τουλάχιστον 18) ΞΕΧΩΡΙΣΤΕΣ εσωτερικές διαδικασίες και " +
    ...
    "\nΧΑΡΑΚΤΗΡΑΣ BPM (πολύ σημαντικό — έτσι ξεχωρίζει από project management):\n" +
    "• Κάθε διαδικασία έχει σαφή ΑΦΟΡΜΗ ΕΝΑΡΞΗΣ (trigger/γεγονός) και σαφές ΑΠΟΤΕΛΕΣΜΑ ΛΗΞΗΣ.\n" +
    "• Κάθε βήμα (task) είναι μια ΕΝΕΡΓΕΙΑ ΡΟΗΣ που εκτελεί ΕΝΑΣ ΡΟΛΟΣ/ΤΜΗΜΑ. Ξεκίνα το \"name\" του βήματος με τον ρόλο, " +
    "π.χ. \"Αιτών: Υποβολή αιτήματος\", \"Προϊστάμενος: Έγκριση\", \"Λογιστήριο: Καταχώριση\", \"Προμηθευτής: Παράδοση\".\n" +
    "• Περίλαβε βήματα ΕΓΚΡΙΣΗΣ / ΕΛΕΓΧΟΥ / ΑΠΟΦΑΣΗΣ (gateways) όπου ταιριάζει (π.χ. έγκριση δαπάνης, έλεγχος παραλαβής).\n" +
    "• Στο \"description\" κάθε βήματος περιέγραψε: ποιος το κάνει (ρόλος), τι εισέρχεται (input), τι παράγεται (output) και " +
    "τυχόν επιχειρησιακό κανόνα/προϋπόθεση. Η ροή να είναι λογικά ΔΙΑΔΟΧΙΚΗ (το output του ενός τροφοδοτεί το επόμενο).\n" +
    "• Το \"needFile\": true σε βήματα όπου ανεβαίνει παραστατικό/έγγραφο (τιμολόγιο, παραστατικό εξόδου, δελτίο αποστολής κ.λπ.).\n" +
    "\nΚΑΛΥΨΗ: Οι διαδικασίες να είναι ΣΧΕΤΙΚΕΣ με τους ΚΑΔ, ΑΛΛΑ περίλαβε ΟΠΩΣΔΗΠΟΤΕ και τις παρακάτω ΕΣΩΤΕΡΙΚΕΣ/ΔΙΟΙΚΗΤΙΚΕΣ " +
    "διαδικασίες (ανεξάρτητα αντικειμένου): υποβολή & έγκριση εξοδολογίου/δαπανών, αίτημα & έγκριση προμήθειας εξοπλισμού, " +
    "αλλαγή/αντικατάσταση εξοπλισμού, χρέωση & διαχείριση παγίων/εξοπλισμού σε εργαζόμενο, αίτημα προμηθειών (requisition → έγκριση → " +
    "παραγγελία → παραλαβή), αίτημα & έγκριση εκπαίδευσης προσωπικού, αίτημα άδειας, onboarding νέου εργαζομένου, " +
    "offboarding/αποχώρηση, αίτημα υποστήριξης IT, συντήρηση εξοπλισμού. Κάλυψε επίσης πωλήσεις, τιμολόγηση, εξυπηρέτηση, ποιότητα και συμμόρφωση. " +
    "Το πεδίο \"description\" κάθε ΔΙΑΔΙΚΑΣΙΑΣ είναι μια ΚΑΘΑΡΗ ΕΠΕΞΗΓΗΣΗ (1-2 προτάσεις): τι κάνει η διαδικασία, ποιος την ξεκινά και γιατί ωφελεί την εταιρία. " +
    "\nΚανόνες: Όλα τα κείμενα στα Ελληνικά. Περίπου 20 διαδικασίες (τουλάχιστον 18). Κάθε διαδικασία 3 έως 6 βήματα (ώστε να αποδίδεται η ροή) και " +
    "έως 6 πεδία (σύντομα, ώστε να χωρέσουν όλες). " +
    'Το "type" κάθε πεδίου είναι ΕΝΑ από: "STRING","TEXT","NUMBER","DATE","FILE_URL","BOOLEAN". ' +
    'Το "captureTaskOrder" είναι ο δείκτης (0-based) του βήματος στο οποίο συμπληρώνεται το πεδίο, ' +
